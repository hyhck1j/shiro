  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small><a href="/admin/resource/list.do">用户管理</a></small> / <small>编辑用户</small></div>
      </div>
      <hr>
      <div class="am-g">
        <div class="am-u-sm-12">
          <form class="am-form am-form-horizontal" id="editForm">
            <div class="am-form-group">
              <label for="resourceName" class="am-u-sm-3 am-form-label">资源名称</label>
              <div class="am-u-sm-9">
                <input type="text" id="resourceName" name="resourceName" placeholder="资源名称" value="${tbResource.resourceName }">
               <input type="hidden" id="resourceId" name="resourceId" placeholder="编号" value="${tbResource.resourceId }">
            ...
            <div class="am-form-group">
              <label for="resourceUrl" class="am-u-sm-3 am-form-label">资源路径</label>
              <div class="am-u-sm-9">
                <input type="text" id="resourceUrl" name="resourceUrl" placeholder="资源路径" value="${tbResource.resourceUrl }">
                <small>资源路径</small>
              </div>
            </div>
...
$(function(){
	$('#edit').on('click',function(){
		...
		$.post('/admin/resource/update.do',formData,function(rst){
			console.debug(rst) ;
			if(rst.code == 'error'){
				alert(rst.message) ;
			}else{
				if(confirm(rst.message +" ,您是否要跳转到列表页面")){
					window.location.href="/admin/resource/list.do";
				}
			}
		});
	});
